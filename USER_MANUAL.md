...
- **Responsive Non-Overlapping Header UI (`RoomHeader.tsx`)**: Responsive 2-tier flex layout with shrink-proof action toolbars, compact status badges, and zero overlapping across mobile, tablet, and desktop screens.
